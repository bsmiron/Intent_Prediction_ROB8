...
hand_x,hand_y,hand_z, = [50, 50, 50]
x_blue, y_blue, z_blue = [0,0,0] 
x_red, y_red, z_red = [10,10,0]
x_green, y_green, z_green = [20,20,0]
x_orange, y_orange, z_orange = [30,30,3]
x_yellow, y_yellow, z_yellow = [50,50,0]
x_purple, y_purple, z_purple = [30,50,10]
